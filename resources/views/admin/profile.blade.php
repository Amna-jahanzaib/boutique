              ...
              <div class="card-body box-profile">
                ...
                @if($user->photo)
                  <a href="{{ $user->photo->getUrl() }}" target="_blank">
                    <img class="profile-user-img img-fluid img-circle"  src="{{ $user->photo->getUrl() }}" width="50px" height="50px">
                  </a>
                @endif
                </div>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form method="POST"  class="form-horizontal" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
