                  ...
                  <tbody class="border-0">
                    ...
                    <tr>
                      ...
                      <td class="p-3 align-middle border-light"><a class="reset-anchor" href="{{route('delete.cart.item',$cart_item->id)}}">
                        ...
                        <form action="{{ route('delete.cart.item',$cart_item->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
                                        <input type="hidden" name="_method" value="DELETE">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <button type="submit" style="background:none; border:none;"><i class="fas fa-trash-alt small text-muted"></i></button>
                                    </form>
                      </a></td>
                    </tr>
                    @endforeach
